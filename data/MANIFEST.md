...
- **fertiliser_demand.csv** (97 rows, added 2026-07-23) — `year, product, measure, quantity_lmt, value_rs_cr, source, note`: DBT PoS sales + assessed requirement (urea/DAP/MOP/NPKS, 2022-23→2025-26), production (2022-23→2024-25 + 2014-15 benchmarks), imports (2016-17→2020-21 all products; DAP 2023-25 incl. China split), nano urea/DAP capacity & sales (bottles), subsidy outgo FY20→FY26 (peak FY23 ₹2.55 lakh cr) + FY23 component split + seasonal NBS budgets + DAP special packages. Every row carries an exact PIB PRID URL. Analysis: `report/fertiliser-and-cost-of-production.md`.
- **cost_of_production.csv** (98 rows, added 2026-07-23) — `marketing_season, season_type, crop, msp_rs_qtl, cost_a2fl_rs_qtl, margin_over_a2fl_pct_pib, margin_over_a2fl_pct_derived, c2_rs_qtl, margin_over_c2_pct_derived, source_msp_cost, source_c2, note`: all mandated kharif (KMS 2022-23→2026-27) + rabi (RMS 2022-23→2026-27) crops. MSP + A2+FL from CCEA MSP releases (PIB PRIDs per row); C2 from CACP price-policy projections via farmingcosmos/FAS (PIB never publishes C2). Headline: paddy margin over C2 stuck at 13–14.5% vs wheat 35–43%; C2 blank where not publicly located (KMS 2026-27, RMS 2022-23) — never estimated.
